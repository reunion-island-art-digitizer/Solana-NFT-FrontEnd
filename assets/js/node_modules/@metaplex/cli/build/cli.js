...
programCommand('upload')
    ...
    var _a, number, keypair, env, cacheName, parsedNumber, pngFileCount, jsonFileCount, startMs, successful, endMs, timeTaken;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _b.label = 1;
            case 1: return [4 /*yield*/, upload_1.upload(files, cacheName, env, keypair, parsedNumber)];
            case 2:
                successful = _b.sent();
                if (successful) {
                    return [3 /*break*/, 4];
...
programCommand('create_candy_machine')
    ...
    .action(function (directory, cmd) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, keypair, env, price, cacheName, lamports, cacheContent, walletKeyPair, anchorProgram, config, _b, candyMachine, bump;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _a = cmd.opts(), keypair = _a.keypair, env = _a.env, price = _a.price, cacheName = _a.cacheName;
...
programCommand('sign_all')
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = cmd.opts(), keypair = _a.keypair, env = _a.env;
                return [4 /*yield*/, sign_1.signAllUnapprovedMetadata(keypair, env)];
            case 1:
                _b.sent();
                return [2 /*return*/];
        }
